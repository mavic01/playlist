...
function nextSong(){
    songIndex++
    if(songIndex > 132){
        songIndex = songs.length - 133 //aka the first song in the index
    }
    loadSong(songs[songIndex])
