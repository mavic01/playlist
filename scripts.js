...
function nextSong(){
    songIndex++
    if(songIndex > 253){
        songIndex = songs.length - 254 //aka the first song in the index
    }
    loadSong(songs[songIndex])
