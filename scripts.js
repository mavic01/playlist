...
function nextSong(){
    songIndex++
    if(songIndex > 256){
        songIndex = songs.length - 257 //aka the first song in the index
    }
    loadSong(songs[songIndex])
