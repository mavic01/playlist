...
function nextSong(){
    songIndex++
    if(songIndex > 156){
        songIndex = songs.length - 157 //aka the first song in the index
    }
    loadSong(songs[songIndex])
