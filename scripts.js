...
function nextSong(){
    songIndex++
    if(songIndex > 378){
        songIndex = songs.length - 379 //aka the first song in the index
    }
    loadSong(songs[songIndex])
