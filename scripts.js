...
function nextSong(){
    songIndex++
    if(songIndex > 207){
        songIndex = songs.length - 208 //aka the first song in the index
    }
    loadSong(songs[songIndex])
