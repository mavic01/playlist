...
function nextSong(){
    songIndex++
    if(songIndex > 114){
        songIndex = songs.length - 115 //aka the first song in the index
    }
    loadSong(songs[songIndex])
