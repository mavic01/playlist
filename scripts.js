...
function nextSong(){
    songIndex++
    if(songIndex > 129){
        songIndex = songs.length - 130 //aka the first song in the index
    }
    loadSong(songs[songIndex])
