...
function nextSong(){
    songIndex++
    if(songIndex > 323){
        songIndex = songs.length - 324 //aka the first song in the index
    }
    loadSong(songs[songIndex])
