...
function nextSong(){
    songIndex++
    if(songIndex > 242){
        songIndex = songs.length - 243 //aka the first song in the index
    }
    loadSong(songs[songIndex])
