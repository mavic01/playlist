...
function nextSong(){
    songIndex++
    if(songIndex > 75){
        songIndex = songs.length - 76 //aka the first song in the index
    }
    loadSong(songs[songIndex])
