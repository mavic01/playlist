...
function nextSong(){
    songIndex++
    if(songIndex > 206){
        songIndex = songs.length - 207 //aka the first song in the index
    }
    loadSong(songs[songIndex])
