...
function nextSong(){
    songIndex++
    if(songIndex > 155){
        songIndex = songs.length - 156 //aka the first song in the index
    }
    loadSong(songs[songIndex])
