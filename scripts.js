...
function nextSong(){
    songIndex++
    if(songIndex > 196){
        songIndex = songs.length - 197 //aka the first song in the index
    }
    loadSong(songs[songIndex])
