...
function nextSong(){
    songIndex++
    if(songIndex > 54){
        songIndex = songs.length - 55 //aka the first song in the index
    }
    loadSong(songs[songIndex])
