...
function nextSong(){
    songIndex++
    if(songIndex > 159){
        songIndex = songs.length - 160 //aka the first song in the index
    }
    loadSong(songs[songIndex])
