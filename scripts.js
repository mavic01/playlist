...
function nextSong(){
    songIndex++
    if(songIndex > 223){
        songIndex = songs.length - 224 //aka the first song in the index
    }
    loadSong(songs[songIndex])
