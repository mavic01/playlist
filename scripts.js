...
function nextSong(){
    songIndex++
    if(songIndex > 208){
        songIndex = songs.length - 209 //aka the first song in the index
    }
    loadSong(songs[songIndex])
