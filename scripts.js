...
function nextSong(){
    songIndex++
    if(songIndex > 260){
        songIndex = songs.length - 261 //aka the first song in the index
    }
    loadSong(songs[songIndex])
