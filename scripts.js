...
function nextSong(){
    songIndex++
    if(songIndex > 250){
        songIndex = songs.length - 251 //aka the first song in the index
    }
    loadSong(songs[songIndex])
