...
function nextSong(){
    songIndex++
    if(songIndex > 313){
        songIndex = songs.length - 314 //aka the first song in the index
    }
    loadSong(songs[songIndex])
