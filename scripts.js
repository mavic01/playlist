...
function nextSong(){
    songIndex++
    if(songIndex > 377){
        songIndex = songs.length - 378 //aka the first song in the index
    }
    loadSong(songs[songIndex])
