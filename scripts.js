...
function nextSong(){
    songIndex++
    if(songIndex > 162){
        songIndex = songs.length - 163 //aka the first song in the index
    }
    loadSong(songs[songIndex])
