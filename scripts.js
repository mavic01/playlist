...
function nextSong(){
    songIndex++
    if(songIndex > 406){
        songIndex = songs.length - 407 //aka the first song in the index
    }
    loadSong(songs[songIndex])
