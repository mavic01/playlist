...
function nextSong(){
    songIndex++
    if(songIndex > 137){
        songIndex = songs.length - 138 //aka the first song in the index
    }
    loadSong(songs[songIndex])
