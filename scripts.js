...
function nextSong(){
    songIndex++
    if(songIndex > 213){
        songIndex = songs.length - 214 //aka the first song in the index
    }
    loadSong(songs[songIndex])
