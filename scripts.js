...
function nextSong(){
    songIndex++
    if(songIndex > 330){
        songIndex = songs.length - 331 //aka the first song in the index
    }
    loadSong(songs[songIndex])
