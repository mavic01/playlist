...
function nextSong(){
    songIndex++
    if(songIndex > 360){
        songIndex = songs.length - 361 //aka the first song in the index
    }
    loadSong(songs[songIndex])
