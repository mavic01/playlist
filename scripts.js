...
function nextSong(){
    songIndex++
    if(songIndex > 300){
        songIndex = songs.length - 301 //aka the first song in the index
    }
    loadSong(songs[songIndex])
