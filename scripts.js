...
function nextSong(){
    songIndex++
    if(songIndex > 365){
        songIndex = songs.length - 366 //aka the first song in the index
    }
    loadSong(songs[songIndex])
